...
export const nav: { label: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { icon: Truck, name: "Purchases", children: [
        ...
        { name: "Purchase List", to: "/module/purchase-list" },
        { name: "Purchase Orders", to: "/module/purchase-orders" },
        { name: "Lost & Damaged Items", to: "/module/lost-damaged" },
        { name: "Purchase Return", to: "/module/purchase-return" },
        { name: "Supplier Payments", to: "/module/supplier-payments" },
      ]},
    ],
  },
  {
    ...
    items: [
      { icon: ReceiptText, name: "Sales & Billing", children: [
        { name: "Sales Invoice", to: "/module/sales-invoice" },
        { name: "Paid Sales List", to: "/module/paid-sales" },
        { name: "Unpaid Sales List", to: "/module/unpaid-sales" },
        { name: "Loans", to: "/module/loans" },
        { name: "Sales Return", to: "/module/sales-return" },
        { name: "Recovery Entry", to: "/module/recovery-entry" },
      ]},
      { icon: BookUser, name: "Ledgers & Profiles", children: [
        { name: "All Ledgers List", to: "/module/all-ledgers" },
        { name: "Customer Ledgers", to: "/module/customer-ledgers" },
        { name: "Supplier Ledgers", to: "/module/supplier-ledgers" },
        { name: "Employee Ledgers", to: "/module/employee-ledgers" },
        { name: "Sales Man Ledgers", to: "/module/salesman-ledgers" },
        { name: "Expenses Ledgers", to: "/module/expenses-ledgers" },
        { name: "General Ledgers", to: "/module/general-ledgers" },
        { name: "Bank Accounts", to: "/module/bank-accounts" },
        { name: "Cash & Bank Balances", to: "/module/cash-bank-balances" },
      ]},
    ],
  },
  {
    ...
    items: [
      { icon: Users, name: "Personnel & HR", children: [
        { name: "Ledger Statements", to: "/module/hr-ledger-statements" },
        { name: "Advance & Loans", to: "/module/advance-loans" },
        { name: "Salary Payouts", to: "/module/salary-payouts" },
      ]},
      { icon: BookOpenText, name: "Finance Book", children: [
        { name: "Cash Book", to: "/module/cash-book" },
        { name: "Bank Book", to: "/module/bank-book" },
        { name: "Income Entry", to: "/module/income-entry" },
        { name: "Expense Entry", to: "/module/expense-entry" },
      ]},
      { icon: BarChart3, name: "Reports Hub", children: [
        { name: "Product Report", to: "/module/product-report" },
        { name: "Stock Report", to: "/module/stock-report" },
